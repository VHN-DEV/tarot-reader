...
```bash
git clone https://github.com/VHN-DEV/tarot-reader.git
cd tarot-reader
```
...
```
https://tarot.VHN-DEV.dev
```

If you have multiple domains (e.g., with and without www):
```
https://tarot.VHN-DEV.dev,https://www.tarot.VHN-DEV.dev
```
...
- Repository: [https://github.com/VHN-DEV/tarot-reader](https://github.com/VHN-DEV/tarot-reader)
